...
role with optional role session name, mask-aws-account-id setting and role session duration to your GitHub Workflow via the `awsCreds.fromOpenIdConnect` API:
