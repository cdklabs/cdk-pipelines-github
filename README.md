...
pipeline.addStageWithGitHubOptions(
  new MyStage(this, "Beta", {
    env: BETA_ENV,
    gitHubEnvironment: "beta",
  })
);
pipeline.addStageWithGitHubOptions(
  new MyStage(this, "Prod", {
    env: PROD_ENV,
...
A comment can be added to the top or bottom of the pipeline. This can be used to
add boilerplate explaining the pipeline file as well as describe what's being
deployed.
...
See ReadMe.md for instructions and explanation.`;

pipeline.workflowFile.commentAtBottom = `THE END`;
```
