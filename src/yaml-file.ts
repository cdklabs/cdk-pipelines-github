...
export class YamlFile {
  ...
  /**
   * Internal storage for commentBefore accessors.
   */
  private _commentBefore?: string;

  /**
   * Internal storage for commentAfter accessors.
   */
  private _commentAfter?: string;
   ...
   * ```
   */
  public set commentAtTop(v: string | undefined) {
    this._commentBefore = v;
  }

  public get commentAtTop(): string | undefined {
    return this._commentBefore;
  }
   ...
   * ```
   */
  public set commentAtBottom(v: string | undefined) {
    this._commentAfter = v;
  }

  public get commentAtBottom(): string | undefined {
    return this._commentAfter;
  }
  ...
  public toYaml(): string {
    ...
    yamlDoc.commentBefore = this._commentBefore ?? null;
    yamlDoc.comment = this._commentAfter ?? null;
